  ...
  async _loop () {
    while (this.stopped === false) {
      if (asNumber(this._latestHeight) - this._confirmations <= this._height) {
        this._logger.error('Refreshing latest block height')
      ...
      this._logger.error("Fetching logs from ${this._height} to ${maxHeight} -- ${this._filters.keys().length}")
