...
// Aliases
const ChainEvent = vega.commands.v1.validator_commands.ChainEvent

const ERC20Event = vega.chain_events.ERC20Event
const ERC20AssetList = vega.chain_events.ERC20AssetList
const ERC20AssetDelist = vega.chain_events.ERC20AssetDelist
const ERC20Deposit = vega.chain_events.ERC20Deposit
const ERC20Withdrawal = vega.chain_events.ERC20Withdrawal
const StakingEvent = vega.chain_events.StakingEvent
const StakeDeposited = vega.chain_events.StakeDeposited
const StakeRemoved = vega.chain_events.StakeRemoved

const PropagateChainEventRequest = vega.api.v1.core.PropagateChainEventRequest
...
module.exports = class EthTail {
  constructor ({
    ...
    this._iter = new EthTransactionIterator({
      ...
      startHeight,
      onlog: async (log) => {
        if (log?.address == null) return logger.fatal(log)
